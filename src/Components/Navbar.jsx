      ...
      <img src={imgg} alt="Logo" width="200" height="40"/> 
        <div>
          <ul id="navbar">
            ...
            {/* <li>
            <span class="dropdown-toggle"  onMouseOver={toggleDropdown} >Industry Expertise</span>
              <span class = "drop-down-icon"></span>
                <svg  onClick={toggleDropdown} class="rotate-90" viewBox="0 0 30 48"  version="1.1" xmlns="https://www.w3.org/2000/svg" width="10" height="10" >
             ...
             <li>
              <a href="index.html" onMouseOver={toggleDropdown}> Industry Expertise </a>
              <span class = "drop-down-icon"></span>
